...
// internal import
import shopImage from '../../assets/images/car_dealership.jpeg'; 
        ...
        <Root>
            ...
            <Main>
                <MainText>
                    ...
                    <Button sx={{ marginTop: '10px'}} component={Link} to={ myAuth === 'true' ? "/shop" : "/auth"} variant='contained'>Click here for amazing vehicles 🛻</Button>
                </MainText>
            </Main>
        </Root>
    )
